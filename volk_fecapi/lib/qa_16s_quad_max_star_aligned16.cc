...
#include <volk_fecapi/volk_fecapi_16s_quad_max_star_aligned16.h>
#include <cstdlib>
#include <ctime>
...
void qa_16s_quad_max_star_aligned16::t1() {
  ...
  volk_fecapi_16s_quad_max_star_aligned16_manual(output0, input0, input1, input2, input3, 2*vlen, "generic");

  volk_fecapi_16s_quad_max_star_aligned16_manual(output1, input0, input1, input2, input3, 2*vlen, "sse2");
