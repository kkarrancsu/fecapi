...
#include <volk_fecapi/volk_fecapi_16s_permute_and_scalar_add_aligned16.h>
#include <cstdlib>
#include <ctime>
...
void qa_16s_permute_and_scalar_add_aligned16::t1() {
  ...
  for(int i = 0; i < 100000; ++i) {
    volk_fecapi_16s_permute_and_scalar_add_aligned16_manual(target, src0, permute_indexes, cntl0, cntl1, cntl2, cntl3, scalars, num_bytes, "generic");
  }
  end = clock();
  ...
  start = clock();
  for(int i = 0; i < 100000; ++i) {
    volk_fecapi_16s_permute_and_scalar_add_aligned16_manual(target2, src0, permute_indexes, cntl0, cntl1, cntl2, cntl3, scalars, num_bytes, "sse2");
  }
  end = clock();
