...
tpc_make_encoder (std::vector<int> row_poly, std::vector<int> col_poly, int krow, int kcol, int bval, int qval);


class FEC_API tpc_encoder : public generic_encoder {
    //befriend the global, swigged make function
    friend generic_encoder_sptr
    tpc_make_encoder (std::vector<int> row_polys, std::vector<int> col_polys, int krow, int kcol, int bval, int qval);
