	...
	*/
	...
	for (k=LL+mm-1;k>=0;k--) {	
		...
		for (i=0;i<nn;i++)
           ...
           mexPrintf("k=%d\n",k);
           mexPrintf("rec_array -->\n");
           for(zzz=0; zzz<nn; zzz++) {
               mexPrintf("%f ", rec_array[zzz]);
           }
           mexPrintf("\n");
           */
		...
		for (i=0;i<number_symbols;i++)
            ...
            /*
            mexPrintf("metric_c -->\n");
            for(zzz=0; zzz<number_symbols; zzz++) {
                mexPrintf("%f ", metric_c[zzz]);
            }
            mexPrintf("\n");
            */
		...
		for ( state=0; state< max_states; state++ ) {		
            ...
            /*
            mexPrintf("delta1=%f delta2=%f beta=%f\n", delta1, delta2, beta[ k*max_states + state]);
            */
		}
	...
	for (k=1;k<=LL+mm;k++) {	
        ...
        */
		for ( state=0; state<max_states; state++ ) {		
            ...
            /*
            mexPrintf("%f %f %f\n", delta1, delta2, alpha[ state0[state] ]);
            */
            ...
            /*
            mexPrintf("%f %f %f\n", delta1, delta2, alpha[ state1[state] ]);
            */
		}
        /*
        mexPrintf("\n");
